...
#get rates from openexchangerates.org. for demo purpose, download an example exchange json file and perform the tasks.
'''
...
def download_rates():
    BASE_URL = "https://gist.github.com/ranjanravi7796/38d4ca0be7eed20aa8f759508516a0fb"
    ENDPOINTS = {
...
with DAG("forex_data_pipeline", start_date=datetime(2021, 1, 1),
    ...
    is_forex_rates_available = HttpSensor(
        ...
        endpoint="ranjanravi7796/38d4ca0be7eed20aa8f759508516a0fb",
